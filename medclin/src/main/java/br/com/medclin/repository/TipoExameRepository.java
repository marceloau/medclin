...
public interface TipoExameRepository
	...
	@Query(value = "SELECT tC FROM TipoExame tC WHERE tC.codigoTipoExame = :codigoTipoExame")
	TipoExame buscarTipoExamePorCodigo(@Param("codigoTipoExame") final Short codigoTipoExame);

	@Query(value = "SELECT tC FROM TipoExame tC WHERE tC.nomeTipoExame LIKE %:nomeTipoExame%")
	Page<TipoExame> buscarTipoExamePorNome(@Param("nomeTipoExame") final String nomeTipoExame,
			final Pageable page);

	@Query(value = "SELECT tC.dataCriacao FROM TipoExame tC WHERE tC.codigoTipoExame = :codigoTipoExame")
