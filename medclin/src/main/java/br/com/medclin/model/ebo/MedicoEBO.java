...
public class MedicoEBO {

	private String numeroCRM;

	private List<Especialidade> listaEspecialidadeMedico;
	...
	public List<Especialidade> getListaEspecialidadeMedico() {
		return listaEspecialidadeMedico;
	}

	public void setListaEspecialidadeMedico(List<Especialidade> listaEspecialidadeMedico) {
